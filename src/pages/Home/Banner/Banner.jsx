  ...
  return (
    <div className="carousel w-full h-[600px]">
      <div id="slide1" className="carousel-item relative w-full">
        ...
        <div className="absolute h-full flex  items-center  left-0  top-0 bg-gradient-to-r rounded-l-xl from-[#151515] to-[rgba(21, 21, 21, 0)]">
        ...
        <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0">
          <a href="#slide4" className="btn btn-circle btn-error mr-5">
            ❮
          </a>
      ...
      <div id="slide2" className="carousel-item relative w-full">
        ...
        <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0">
          <a href="#slide1" className="btn btn-circle btn-error mr-5">
            ❮
          </a>
      ...
      <div id="slide3" className="carousel-item relative w-full">
        ...
        <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0">
          <a href="#slide2" className="btn btn-circle btn-error mr-5">
            ❮
          </a>
      ...
      <div id="slide4" className="carousel-item relative w-full">
        ...
        <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0">
          <a href="#slide3" className="btn btn-circle btn-error mr-5">
            ❮
          </a>
